    ...
    return (
      ...
      <Container>
        <div className="container">
                ...
                <Link style={{textDecoration: 'none',color:'black'}} to="/" className='L' >   <div class="sparkle-button">
...
<button>
  ...
  <span class="text">StreamGod</span>
</button>
...
<span aria-hidden="true" class="particle-pen">
  ...
  <svg class="particle" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    setAuthInfo(()=>(
                    ...
                    <Link style={{textDecoration: 'none',color:'black'}} to="/login" className='L'><button className='btn'>Login </button></Link>
                 }
